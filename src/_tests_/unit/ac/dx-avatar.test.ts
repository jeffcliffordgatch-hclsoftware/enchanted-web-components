...
describe('DxAvatar component testing', () => {
  before(async () => {
  ...
  it('DxAvatar - should render without crashing', async () => {
    let component = document.createElement('dx-avatar');
    document.body.appendChild(component);
    await expect(document.body.contains(component)).toBeTruthy();
    component.remove();
  });

  it('DxAvatar - removes component from document body and validates removal', async () => {
    let component = document.createElement('dx-avatar');
    document.body.appendChild(component);
  ...
  it('DxAvatar - validate default value of attributes', async () => {
    let component = document.createElement('dx-avatar');
    document.body.appendChild(component);
  ...
  it('DxAvatar - set and remove attributes and validate', async () => {
    let component = document.createElement('dx-avatar');
  ...
  it('DxAvatar - should validate null for non-existent attributes', async () => {
    let component = document.createElement('dx-avatar');
    await expect(component.getAttribute('nonExistentAttribute')).toBeNull();
    component.remove();
  });

  it('DxAvatar - should render component with letter variant and validate', async () => {
    render(
      html`
        <dx-avatar
    ...
    let component = await $('dx-avatar').getElement();
    ...
    let divElement = await component.$('>>>div[data-testid="dx-avatar-div"]').getElement();
    let letterElement = await divElement.$('>>>span[data-testid="dx-avatar-letter"]').getElement();
    await expect(letterElement).toHaveText('Ab');
  });

  it('DxAvatar - should render component with icon rounded variant and validate', async () => {
    render(
      html`
        <dx-avatar
    ...
    await expect(component).toHaveAttribute('iconUrl', 'testIconURL');
    let divElement = await component.$('>>>div[data-testid="dx-avatar-div"]').getElement();
    let iconElement = await divElement.$('>>>img[data-testid="dx-avatar-img"]').getElement();
  ...
  it('DxAvatar - should render component with icon circular variant and validate', async () => {
    render(
      html`
        <dx-avatar
          variant=${AVATAR_VARIANT.AVATAR_ICON}
    ...
    await expect(component).toHaveAttribute('variant', AVATAR_VARIANT.AVATAR_ICON);
    await expect(component).toHaveAttribute('iconUrl', 'testIconURL');
    let divElement = await component.$('>>>div[data-testid="dx-avatar-div-circular"]').getElement();
    let iconElement = await divElement.$('>>>img[data-testid="dx-avatar-img"]').getElement();
    let iconUrl = await iconElement.getAttribute('src');
    await expect(iconUrl).toContain('testIconURL');
  ...
  it('DxAvatar - should render component with icon template, rounded, color and validate', async () => {
    render(
      html`
        <dx-avatar
  ...
  it('DxAvatar - should render component with icon template, circular and validate', async () => {
    render(
      html`
        <dx-avatar
          variant=${AVATAR_VARIANT.AVATAR_ICON_TEMPLATE}
  ...
  it('DxAvatar - should render component with selected css as per setting mode in circular variant', async () => {
    render(
      html`
        <dx-avatar
    ...
    await expect(component).toHaveAttribute('iconUrl', 'testIconURL');
    let divElement = await component.$('>>>div[data-testid="dx-avatar-div-circular"]').getElement();
    let imageElement = await divElement.$('>>>img[data-testid="dx-avatar-img"]').getElement();
  ...
  it('DxAvatar - should render component with selected css as per setting mode in rounded variant', async () => {
    render(
      html`
        <dx-avatar
          variant=${AVATAR_VARIANT.AVATAR_IMG}
