...
import { FORMAT_FOR_CONVERTING_TO_UNIX_TIMESTAMP, MAX_YEAR_BUFFER, MIN_YEAR } from '../../../types/dx-datepicker';
import { formatDate, getLocalizedMonths } from '../../../utils/dateUtils';

describe('DxDatepicker component testing', () => {
  ...
  it('DxDatepicker - should render datepicker web component without crashing', async () => {
    let component = document.createElement('dx-datepicker');
    document.body.appendChild(component);
    await expect(document.body.contains(component)).toBeTruthy();
    component.remove();
  });

  it('DxDatepicker - should remove web component from document body and validates removal', async () => {
    let component = document.createElement('dx-datepicker');
    document.body.appendChild(component);
  ...
  it('DxDatepicker - should validate default values of attributes', async () => {
    let component = document.createElement('dx-datepicker');
    document.body.appendChild(component);
  ...
  it('DxDatepicker - should validate custom values of attributes', async () => {
    render(
      html`
        <dx-datepicker
          label="Sample label"
    ...
    const component = await $('dx-datepicker').getElement();
  ...
  it('DxDatepicker - should be able to open calendar and select a date', async () => {
    render(
      html`
  ...
  it('DxDatepicker - should be able to open calendar and select Today', async () => {
    render(
      html`
        <dx-datepicker></dx-datepicker>
      `,
  ...
  it('DxDatepicker - should be able to open calendar and change Year and reopen calendar and year view again', async () => {
    render(
      html`
        <dx-datepicker></dx-datepicker>
      `,
    ...
    let component = await $('dx-datepicker').getElement();
    await expect(component).toBeDisplayed();
    ...
    component = await $('dx-datepicker').getElement();
  ...
  it('DxDatepicker - should be able to open calendar and change to Next Month', async () => {
    render(
      html`
        <dx-datepicker></dx-datepicker>
      `,
  ...
  it('DxDatepicker - should be able to open calendar and change Prev Month', async () => {
    render(
      html`
        <dx-datepicker></dx-datepicker>
      `,
  ...
  it('DxDatepicker - should validate that the component calendar buttons are accessible via Tab and Shift + Tab', async () => {
    render(
      html`
        <dx-datepicker></dx-datepicker>
      `,
  ...
  it('DxDatepicker - should be able to open calendar, change month, navigate to first day of month and select it', async () => {
    render(
      html`
        <dx-datepicker></dx-datepicker>
      `,
  ...
  it('DxDatepicker - should be able to keyboard navigate and select date', async () => {
    render(
      html`
        <dx-datepicker></dx-datepicker>
      `,
  ...
  it('DxDatepicker - should be able to open calendar and close it via Escape key', async () => {
    render(
      html`
        <dx-datepicker></dx-datepicker>
      `,
  ...
  it('DxDatepicker - should be able to go to last supported month and check that next month is disabled', async () => {
    render(
      html`
        <dx-datepicker></dx-datepicker>
      `,
  ...
  it('DxDatepicker - should be able to type a full valid date', async () => {
    let changeEventDetail = '';
    render(
      html`
        <dx-datepicker @date-change=${(e: CustomEvent) => {return changeEventDetail = e.detail.value;} }></dx-datepicker>
      `,
      document.body
    );
  ...
  it('DxDatepicker - should be able to type a partial date and expect invalid hint', async () => {
    let changeEventDetail = '';
    render(
      html`
        <dx-datepicker @date-change=${(e: CustomEvent) => {return changeEventDetail = e.detail.value;} }></dx-datepicker>
