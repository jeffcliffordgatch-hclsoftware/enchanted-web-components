...
describe('DxAnchorTag component testing', () => {
  before(async () => {
  ...
  it('DxAnchorTag - should render without crashing', async () => {
    let component = document.createElement('dx-anchor');
    document.body.appendChild(component);
    await expect(document.body.contains(component)).toBeTruthy();
    component.remove();
  });

  it('DxAnchorTag - remove component from document body and validates removal', async () => {
    let component = document.createElement('dx-anchor');
    document.body.appendChild(component);
  ...
  it('DxAnchorTag - validate default value of attributes', async () => {
    let component = document.createElement('dx-anchor');
    document.body.appendChild(component);
  ...
  it('DxAnchorTag - set and remove attributes and validate', async () => {
    let component = document.createElement('dx-anchor');
  ...
  it('DxAnchorTag - should validate null for non-existent attributes', async () => {
    let component = document.createElement('dx-anchor');
    await expect(component.getAttribute('nonExistentAttribute')).toBeNull();
    component.remove();
  });

  it('DxAnchorTag - should render component and validate attributes', async () => {
    render(
      html`
        <dx-anchor
          url="testURL"
    ...
    let component = await $('dx-anchor').getElement();
    await expect(component).toBeDisplayed();
    let linkElement = await component.$('>>>a[data-testid="dx-anchor-link"]').getElement();
  ...
  it('DxAnchorTag - should render component with selected css as per setting mode', async () => {
    render(
      html`
        <dx-anchor
          url="testURL"
