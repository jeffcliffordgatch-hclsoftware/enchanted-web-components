...
import '@hcl-software/enchanted-icons-web-component/dist/carbon/es/XLS';
 ...
 @customElement('dx-item-type-avatar')
export class DxItemTypeAvatar extends DxAcBaseElement {
   ...
   render() {
     return html`
        <dx-avatar
          data-testId="dx-item-type-avatar"
 ...
 declare global {
   interface HTMLElementTagNameMap {
     'dx-item-type-avatar': DxItemTypeAvatar
   }
 }
